  ...
  for(i in 1:21){
    ...
    data_country <- data.frame("time" = as_date(as.character(dates[[i]])),
      ...
      write.csv(data_country, file = 
                                        paste0("/Users/Leonardo/documents/covid19model-import/Latam_covar_long_results/csv_files/","estimations_past_",i, 
                                               ".csv"), row.names = TRUE)
    ...
    write.csv(data_country_forecast, file = 
                paste0("/Users/Leonardo/documents/covid19model-import/Latam_covar_long_results/csv_files/","estimation_forecast_",i, 
                       ".csv"), row.names = TRUE)
